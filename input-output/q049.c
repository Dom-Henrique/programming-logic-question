...
void main(){
    float buildPrice, originalPrice, promotion;
    const float IPI = 1.20;
    const float ICMS = 1.17;
    const float profit = 1.20;
    printf("Build price of vehicle: ");
    scanf("%f", &buildPrice);
    promotion = buildPrice*ICMS*profit;
    originalPrice = promotion*IPI;
