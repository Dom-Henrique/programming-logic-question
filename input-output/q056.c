...
void main()
{
    // we can converts the character into int by ASCII table
    char letter;
    int newLetter, commonDifference;
    printf("Input the character and common difference: ");
    scanf("%c%d", &letter, &commonDifference);
    newLetter = (int)letter + commonDifference;
